...
import takamatsu.utilities.AStar;
import takamatsu.utilities.InputCleaning;
import takamatsu.utilities.PersonUtilities;
import takamatsu.myobjects.Household;
import takamatsu.myobjects.Person;
import takamatsu.myobjects.Shelter;
import takamatsu.myobjects.TakamatsuBehaviour;
...
public class TakamatsuSim extends SimState {
	...
	public static int forecastArrivalTime = 1440; // in ticks
	public static int forecastingWidthParam = 1440; // in ticks
...
//		random = new MersenneTwisterFast(12345);
	...
	public void start()
    {
		...
		try {
			...
			InputCleaning.readInVectorLayer(floodedLayer, dirName + floodedFilename, "water", new Bag());
...
*/
	...
	public static void main(String[] args)
    {
		...
		if(args.length > 1) {
			...
			boolean neighbourPolicy = Boolean.parseBoolean(args[4]);
			boolean designatedPersonPolicy = Boolean.parseBoolean(args[5]);
