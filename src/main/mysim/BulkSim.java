...
public class BulkSim {
	...
	public static void main(String [] args){
		...
		boolean [] isTsunami = new boolean [] {true,  false};
		Integer [] timelengths = new Integer [] {720 + 60, 720 + 60};
		
		int index = 0;
		for(int j = 0; j < 2; j++) {
			for(int i = 0; i < 30; i++) {
				//runInstance(i, false, false, false, floodwaterFilename[j], timelengths[j], isTsunami[j]);
...
*/
	...
	public static void runInstance(int seed, boolean ageEnabled, boolean neighbourPolicy, 
		...
		String outputFilename = "/Users/swise/Projects/hitomi/data/tsunami/output/sweeper_" + 
